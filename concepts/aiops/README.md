...
The first five-paper formal batch is recorded in [AIOps Knowledge Review v1](../../notes/aiops/reviews/aiops-knowledge-review-v1.md). Concepts remain evolving and should be updated only when later sources add durable cross-paper evidence. Batch 2 adds [Comfey](../../papers/aiops/comfey/notes.md) for production incident triage, [AIM](../../papers/aiops/aim/notes.md) for prompt-level multimodal alert interpretation and plan-to-act, [StepFly](../../papers/aiops/stepfly/notes.md) for bounded TSG execution, and [TSGen](../../papers/aiops/tsgen/notes.md) for historical-incident knowledge curation. These systems should not be generalized into a single physical-RCA or autonomous-Agent architecture without further evidence.
